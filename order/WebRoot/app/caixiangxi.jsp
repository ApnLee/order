...
<link href="${pageContext.request.contextPath }/app/tyle/css/common_style_blue.css" rel="stylesheet" type="text/css">
	...
	<div id="all">
		...
		<div id="menu1">
			<div class="menu2" style="text-align:center;">
				<img src="${pageContext.request.contextPath }/app/tyle/images/order_detials_bg.png" />
			</div>
			<div class="menu3">
			...
			<div class="menu4">
				...
				<a href="${pageContext.request.contextPath }/OrderServlet?method=putCart&foodId=${food.id}" style="background:url(${pageContext.request.contextPath }/app/style/images/img/order_left_corner_bg.png);">放入餐车</a>
