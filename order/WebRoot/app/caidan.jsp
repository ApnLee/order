	...
	<div id="all">
		<div id="menu">
			...
			<div id="top">
				<ul>
					<!-- 循环列出餐品 -->
					<c:forEach items="${pageBean.datas}" var="food">
					
						<li>
							<dl>
								<dt>
	<a href="${pageContext.request.contextPath }/IndexServlet?method=findFoodById&foodId=${food.id}">							
...
<!--				
					<table width="700" border="1">
						<tr>
<c:forEach items="${pageBean.datas}" var="food" varStatus="sta">						
...
-->
		...
		<a href="${pageContext.request.contextPath }/IndexServlet?method=menu&currentPage=1">首页</a>
		<a href="${pageContext.request.contextPath }/IndexServlet?method=menu&currentPage=${requestScope.pageBean.currentPage-1}">上一页 </a>
		<a href="${pageContext.request.contextPath }/IndexServlet?method=menu&currentPage=${requestScope.pageBean.currentPage+1}">下一页 </a>
		<a href="${pageContext.request.contextPath }/IndexServlet?method=menu&currentPage=${requestScope.pageBean.totalPage}">末页</a>
			...
			<div id="dish_2">
				<ul>
					<c:forEach items="${types}" var="type">
						<li>
							<a href="${pageContext.request.contextPath }/IndexServlet?method=menu&foodType=${type.typeName}">${type.typeName}</a>
						</li>
					</c:forEach>
				</ul>
			</div>
			<div id="dish_3">
				...
				<form action="${pageContext.request.contextPath }/IndexServlet" method="post">
					<table width="166px">
						<tr>
							<td>
								<input type="text" id="dish_name" name="foodName" value="${food.foodName }" class="select_value" /> 
								<input type="hidden" value="menu" name="method">
							</td>
						</tr>
						<tr>
