...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/app/style/css/index.css" />
		...
		<div id="menu">
			...
			<div id="count">
				<table align="center" width="100%">
					...
					<c:forEach items="${orderDetail}" var="entry">
						<tr height="60">
					 		<td align="center" width="20%">${entry.foodName }</td>
					 		<td align="center" width="20%">￥${entry.price }</td>
					 		<td align="center" width="20%">${entry.foodCount}</td>
					 		<td align="center" width="20%">${entry.price*entry.foodCount}</td>
				 		</tr>
					</c:forEach>

					<tr>
						<td colspan="6" align="right">总计: <span
							style="font-size:36px;">&yen;&nbsp;<c:out value="${order.totalPrice }"></c:out></span>
		...
		<div id="dish_class">
			<div id="dish_top">
				<ul>
					...
					<li><a
						href="${pageContext.request.contextPath }/app/clientCart.jsp">
							<img
							src="${pageContext.request.contextPath }/app/style/images/call2.gif" />
					</a></li>
				</ul>
			</div>
						...
						<tr>
							<td><a
								href="${pageContext.request.contextPath }/index?method=getMenu">
									<img
									src="${pageContext.request.contextPath }/app/style/images/look.gif" />
							</a></td>
						</tr>
					</table>
				</form>
