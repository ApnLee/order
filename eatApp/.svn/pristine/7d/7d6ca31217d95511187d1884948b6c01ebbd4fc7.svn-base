...
<body>
	...
	<form method="post" action="${pageContext.request.contextPath}/BackSnackServlet?method=add" enctype="multipart/form-data" name="f" onSubmit="return checked()">
		<h2>
			<strong style="color: grey;">添加商品页面</strong>
		</h2>
		<ul class="ulColumn2">
			<li>
				<span class="item_name" style="width: 120px;">商品名称：</span> 
				<input type="text" name="snackName" class="textbox textbox_295" placeholder="请输入商品名称" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">商品价格：</span> 
				<input type="text" name="mktprice" class="textbox textbox_295" placeholder="请输入商品价格" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">促销价格：</span> 
				<input type="text" name="price" class="textbox textbox_295" placeholder="不促销可以不填" />
			</li>
			<li>
			...
			<li>
				...
				<input type="text" name="stock" class="textbox textbox_295" placeholder="请输入库存" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">产品类型：</span> 
				<input type="text" name="type" class="textbox textbox_295" placeholder="请输入产品类型" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">原料产地：</span> 
				<input type="text" name="materialArea" class="textbox textbox_295" placeholder="请输入原料产地" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">产地：</span> 
				<input type="text" name="productionArea" class="textbox textbox_295" placeholder="请输入产地" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">配料表：</span> 
				<input type="text" name="dosing" class="textbox textbox_295" placeholder="请输入配料表" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">产品规格：</span> 
				<input type="text" name="weight" class="textbox textbox_295" placeholder="请输入产品规格" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">保质期：</span> 
				<input type="text" name="expirationDate" class="textbox textbox_295" placeholder="请输入保质期" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">储存方法：</span> 
				<input type="text" name="storeMethod" class="textbox textbox_295" placeholder="请输入储存方法" />
			</li>
			<li>
				<span class="item_name" style="width: 120px;">食用方法：</span> 
				<input type="text" name="edibleMethod" class="textbox textbox_295" placeholder="请输入使用方法" />
			</li>
