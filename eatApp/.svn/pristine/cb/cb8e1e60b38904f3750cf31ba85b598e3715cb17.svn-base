						...
						<div class="check">
							<ul>
								<li>
									...
									<div class="fore3">
										<a href="${pageContext.request.contextPath}/PersonServlet?method=UpDatePassWord&UserName=${UserName}">
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="${pageContext.request.contextPath}/app/safety.jsp">安全设置</a></li>
