...
<head>
		...
		<link href="${pageContext.request.contextPath}/app/css/cmstyle.css" rel="stylesheet" type="text/css">
					...
					<div class="am-container header">
						...
						<ul class="message-r">
							<div class="topMessage home">
								<div class="menu-hd"><a target="_top" class="h" href="${pageContext.request.contextPath}/app/welcome.jsp">商城首页</a></div>
							</div>
									...
									<div class="comment-main">
										<div class="comment-list">
											...
											<ul class="item-list">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a class="J_MakePoint" href="${pageContext.request.contextPath}/ShowServlet?method=introduction&id=${detail.shopid}">
															<img src="${pageContext.request.contextPath}${detail.image}" class="itempic">
														</a>
													</div>
												</li>
												...
												<li class="td td-comment">
													<div class="item-title">
														...
														<c:if test="${detail.valuationlevel==1}">好评</c:if>
														<c:if test="${detail.valuationlevel==2}">中评</c:if>
														<c:if test="${detail.valuationlevel==3}">差评</c:if>
														</div>
														<div class="item-name">
															<a href="${pageContext.request.contextPath}/ShowServlet?method=introduction&id=${detail.shopid}">
																<p class="item-basic-info">${detail.snackName}</p>
															</a>
														</div>
													</div>
													...
													<div class="item-info">
														<div>
															<p class="info-little"><span>口味：${detail.taste}</span><span>数量：${detail.shopcount}</span>  </p>
															<p class="info-time">${detail.commentDate}</p>
