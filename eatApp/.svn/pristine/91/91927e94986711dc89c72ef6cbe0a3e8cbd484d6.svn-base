...
<body>
	...
	<ul class="ulColumn2">
		...
		<li>
			...
			<input type="text" name="waycode" class="textbox textbox_295" placeholder="请输入物流" value="${order.waycode}"  />
		</li>
		<li>
			<span class="item_name" style="width: 120px;">运单号：</span> 
			<input type="text" name="waynum" class="textbox textbox_295" placeholder="请输入用运单号" value="${order.waynum}"  />
		</li>
		<li>
		...
		<li>
			...
			<input type="text" name="address" class="textbox textbox_295" placeholder="请输入地址" value="${order.address}" />
		</li>
