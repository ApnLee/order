...
<body>
	...
	<form method="post" action="${pageContext.request.contextPath}/BackLogisticsServlet?method=update&id=${logistics.id}"  name="f" onSubmit="return checked()">
	<h2>
	...
	<ul class="ulColumn2">
		<li>
			...
			<input type="text" name="logisticsCode" class="textbox textbox_295" value="${logistics.logisticsCode }" placeholder="请输入物流编码" />
		</li>
		<li>
			<span class="item_name" style="width: 120px;">物流公司：</span> 
			<input type="text" name="logisticsCompany" class="textbox textbox_295" value="${logistics.logisticsCompany }" placeholder="请输入物流公司" />
		</li>
