...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/app/css/seastyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="${pageContext.request.contextPath}/app/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/app/js/script.js"></script>
	</head>
	...
	<body>
						...
						<div class="am-u-sm-12 am-u-md-12">
	                  	<div class="theme-popover">														
							...
							<div class="search-content">
								...
								<c:forEach items="${pageBean.datas }" var="snack" varStatus="vs">
									<li>
										<div class="i-pic limit">
									<a href="${pageContext.request.contextPath}/ShowServlet?method=introduction&id=${snack.id }">	
										<img src="${pageContext.request.contextPath }${snack.image}" >
									</a>	
											<!-- 隐藏的文本域 -->
											<input type="hidden" name="id" value="${snack.id }"/>
											<a href="${pageContext.request.contextPath}/ShowServlet?method=introduction&id=${snack.id }" >								
											<p class="title fl">${snack.snackName}</p>
											</a>
											<p class="price fl">
												<b>¥</b>
							...
							<ul class="am-pagination am-pagination-right">
								<li><a href="${pageContext.request.contextPath }/ShowServlet?method=search&currentPage=${pageBean.current-1}">&laquo;</a></li>
								<li class="am-active"><a href="${pageContext.request.contextPath }/ShowServlet?method=search&currentPage=1">首页</a></li>
								<li><a href="${pageContext.request.contextPath }/ShowServlet?method=search&currentPage=${pageBean.total}">末页</a></li>			
								<li><a href="${pageContext.request.contextPath }/ShowServlet?method=search&currentPage=${pageBean.current+1}">&raquo;</a></li>
							</ul>
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="${pageContext.request.contextPath }/welcome.jsp"><i class="am-icon-home "></i>首页</a></li>
